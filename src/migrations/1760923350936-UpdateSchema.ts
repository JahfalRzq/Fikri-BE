...
export class UpdateSchema1760923350936 implements MigrationInterface {
    name = 'UpdateSchema1760923350936'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`training_participant_category\` ADD \`deletedAt\` datetime(6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`training_category\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`certificate\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`training_participant\` CHANGE \`certificateId\` \`certificateId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`training_participant\` CHANGE \`trainingParticipantCategoryId\` \`trainingParticipantCategoryId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`settings\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`training_category\` DROP FOREIGN KEY \`FK_927b6c1094f25ff37a54f77a4e5\``);
        await queryRunner.query(`ALTER TABLE \`training_participant_category\` DROP FOREIGN KEY \`FK_2aaf52cf931474f3e396fc20a05\``);
        await queryRunner.query(`ALTER TABLE \`settings\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`participant\` ADD CONSTRAINT \`FK_b915e97dea27ffd1e40c8003b3b\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`training_participant\` CHANGE \`trainingParticipantCategoryId\` \`trainingParticipantCategoryId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`training_participant\` CHANGE \`certificateId\` \`certificateId\` varchar(36) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`certificate\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`certificate\` ADD CONSTRAINT \`FK_5f12725ed5ff2260869e2ce647a\` FOREIGN KEY (\`trainingParticipantId\`) REFERENCES \`training_participant\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`training_category\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`training_category\` ADD CONSTRAINT \`FK_46ad7fff718b601d4f2958108b6\` FOREIGN KEY (\`trainingId\`) REFERENCES \`training\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`training_category\` ADD CONSTRAINT \`FK_927b6c1094f25ff37a54f77a4e5\` FOREIGN KEY (\`categoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`training_participant_category\` ADD CONSTRAINT \`FK_2aaf52cf931474f3e396fc20a05\` FOREIGN KEY (\`categoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`training_participant_category\` DROP COLUMN \`deletedAt\``);
    }
